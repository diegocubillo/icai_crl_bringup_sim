...
def generate_launch_description():
    ...
    # Spawn the simplified circuit model in the Gazebo world
    spawn_circuit = Node(
        package='ros_gz_sim',
        executable='create',
        arguments=['-name', 'simplified_circuit',
                   '-file', os.path.join(pkg_project_description, 'models', 'environments', 'simplified_circuit')],
        output='screen'
    )
